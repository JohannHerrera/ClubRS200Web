...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">Mi Pérfil</div>
                <div class="card-body">
                    <form
                        method="POST"
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            id="identificationtype_id"
                                            name="identificationtype_id"
                                            class="form-control"
                                            required
                                            autofocus
                                        >
                                            ...
                                            <option
                                                ...
                                                {{ (Auth::user()->identificationtype_id == $identificationType->id) ? 'selected' : '' }}>{{ $identificationType->description }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            name="defaultmotorbike"
                                            value="{{ Auth::user()->defaultmotorbike }}"
                                            required
                                        >
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option
                                                value="{{ $bloodgroup->id }}"
                                                {{ (Auth::user()->bloodgroup_id == $bloodgroup->id) ? 'selected' : '' }}>{{ $bloodgroup->description }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            value="{{ Auth::user()->emergencycontactname }}"
                                            autofocus
                                        >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            value="{{ Auth::user()->emergencycontactnumber }}"
                                            autofocus
                                        >
                                        ...
                                        <div class="form-check form-check-flat">
                                            <label class="form-check-label">
                                                <input
                                                    ...
                                                    data-id="{{Auth::user()->isorgandonor}}"
                                                    {{ Auth::user()->isorgandonor ? 'checked' : '' }}> Si / No
                                            </label>
                                        </div>
                                    </div>
